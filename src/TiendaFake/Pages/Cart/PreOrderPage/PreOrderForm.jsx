...
export default function PreOrderForm() {
  ...
  const handleChange = (e) => {
    ...
    if(form.direccion !== '' && form.email !== '' && form.nombre !== '' && form.tel !== '' ) {
      setIsDisabled(false);
    }
  ...
  return (
    <form onSubmit={(e) => onSubmit(e)} className="space-y-4">
      ...
      <button
        type="submit"
        disabled={IsDisabled}
        className={`w-full ${IsDisabled ? 'bg-gray-400' : 'bg-blue-600 hover:bg-blue-700'}  text-white py-2 px-4 rounded-lg transition-all`}
      >
        Pagar Pedido
      </button>
    </form>
